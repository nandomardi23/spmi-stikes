...
function EmptyState({ icon, title, message, description, asDiv = false }) {
    const content = (
        <div className="flex flex-col items-center justify-center max-w-sm mx-auto text-center py-16 px-6">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">{message || description || 'Belum ada data apa pun yang ditambahkan di tabel ini. Silakan buat data baru melalui tombol tambah di atas.'}</p>
        </div>
    );
