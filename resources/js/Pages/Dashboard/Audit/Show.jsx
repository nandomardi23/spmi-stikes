            ...
            <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div>
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                        ...
                        <h3 className="text-sm font-extrabold text-gray-900 mb-3 mt-6 uppercase tracking-wider">Cetak Dokumen</h3>
                        <div className="space-y-2">
                            <a href={`/dashboard/export/berita-acara/${audit.id}`} target="_blank" className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-emerald-50 text-emerald-700 font-bold rounded-xl hover:bg-emerald-100 transition duration-200 text-xs border border-emerald-100/50">
                            ...
                            <a href={`/dashboard/export/surat-tugas/${audit.id}`} target="_blank" className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-50 text-blue-700 font-bold rounded-xl hover:bg-blue-100 transition duration-200 text-xs border border-blue-100/50">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4"><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" /></svg>
                                Cetak Surat Tugas
                            </a>
                        </div>
