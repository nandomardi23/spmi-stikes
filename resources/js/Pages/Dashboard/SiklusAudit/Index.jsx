    ...
    return (
        <DashboardLayout title="Siklus Audit">
            ...
            <div className="flex justify-between items-center mb-6">
                ...
                <Link href="/dashboard/siklus-audit/create" className="px-5 py-2.5 bg-linear-to-br from-primary-600 to-primary-700 text-white rounded-xl text-sm font-semibold hover:from-primary-700 hover:to-primary-800 transition shadow-lg shadow-primary-500/25">+ Tambah Siklus</Link>
            </div>
