...
function Index({ unitKerjas, users }) {
  ...
  return /* @__PURE__ */ jsxs(DashboardLayout, { title: "Unit Kerja", children: [
    /* @__PURE__ */ jsx(Head, { title: "Unit Kerja" }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Kelola unit kerja auditee dan pimpinan unit" })
      ] }),
      /* @__PURE__ */ jsx(
        "button",
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden", children: [
      /* @__PURE__ */ jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxs("table", { className: "w-full text-sm", children: [
        /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "border-b border-gray-100 bg-gray-50/50", children: [
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4 font-semibold text-gray-600 uppercase tracking-wider text-[10px]", children: "Informasi Unit" }),
          /* @__PURE__ */ jsx("th", { className: "px-6 py-4 font-semibold text-gray-600 uppercase tracking-wider text-[10px]", children: "Ketua / Kepala" }),
        ...
        /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-gray-50", children: unitKerjas.data.length > 0 ? unitKerjas.data.map((u) => /* @__PURE__ */ jsxs("tr", { className: "hover:bg-gray-50/50 transition", children: [
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-linear-to-br from-gray-50 to-gray-100 border border-gray-100 rounded-xl flex items-center justify-center text-primary-600 font-extrabold text-xs", children: u.kode || "UK" }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "font-bold text-gray-900", children: u.nama }),
          ...
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4 font-medium text-gray-700", children: u.kepala_unit || "-" }),
          /* @__PURE__ */ jsx("td", { className: "px-6 py-4", children: /* @__PURE__ */ jsx("span", { className: "px-2.5 py-1 bg-primary-50 text-primary-700 text-[10px] font-bold rounded-lg border border-primary-100 uppercase tracking-tight", children: u.jenis?.replace("_", " ") }) }),
        ...
        ] }, u.id)) : /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 4, children: /* @__PURE__ */ jsx(EmptyState, { title: "Unit Kerja Belum Tersedia", message: "Silakan tambahkan unit kerja baru untuk mengawali data." }) }) }) })
      ] }) }),
      unitKerjas.links && unitKerjas.links.length > 3 && /* @__PURE__ */ jsx("div", { className: "px-6 py-4 border-t border-gray-100 flex justify-end gap-1", children: unitKerjas.links.map((link, i) => /* @__PURE__ */ jsx(
        Link,
        {
          href: link.url || "#",
    ...
    /* @__PURE__ */ jsx(Modal, { show: isModalOpen, onClose: closeModal, children: /* @__PURE__ */ jsxs("div", { className: "p-7", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-xl font-extrabold text-gray-900 mb-6 tracking-tight", children: editingData ? "Edit Unit Kerja" : "Tambah Unit Kerja Baru" }),
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxs(
            "select",
            {
              ...
              className: "w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm outline-none focus:ring-2 focus:ring-primary-500 font-bold",
              children: [
                /* @__PURE__ */ jsx("option", { value: "prodi", children: "Program Studi (Prodi)" }),
                /* @__PURE__ */ jsx("option", { value: "unit", children: "Fakultas / Pimpinan" }),
                /* @__PURE__ */ jsx("option", { value: "bagian", children: "Biro / Bagian" }),
                /* @__PURE__ */ jsx("option", { value: "lembaga", children: "Lembaga / Pusat" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-bold text-gray-700 mb-1.5", children: "Nama Ketua / Kepala Unit" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "text",
          ...
          errors.kepala_unit && /* @__PURE__ */ jsx("p", { className: "mt-1.5 text-[10px] font-bold text-danger-500", children: errors.kepala_unit })
        ] }),
        /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3 pt-6 border-t border-gray-100", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: processing ? "Sedang Memproses..." : editingData ? "Perbarui Unit" : "Simpan Unit"
            }
          )
        ] })
      ] })
